...
function TeamShow() {
  const emily = 'https://github.com/Bill-the-dev/Unshelvd_MERN/blob/main/frontend/src/components/splash/emily.jpg'
  const bill = 'https://github.com/Bill-the-dev/Unshelvd_MERN/blob/main/frontend/src/components/splash/bill.jpg'
  const ethan = 'https://github.com/Bill-the-dev/Unshelvd_MERN/blob/main/frontend/src/components/splash/ethan.jpg'
  const kirby = 'https://github.com/Bill-the-dev/Unshelvd_MERN/blob/main/frontend/src/components/splash/kirby.jpg'
  return (
