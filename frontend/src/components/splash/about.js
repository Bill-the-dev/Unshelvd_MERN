  ...
  return (
    <div className="about-container">
      ...
      <div className="about-body">
        ...
        <br/>
        <p>It will give you suggestions for Connected (online) or Unplugged (in-person) games to play based on what's already on your shelf... or what you have in common with another user!</p>
      </div>
    </div>
  )
}
